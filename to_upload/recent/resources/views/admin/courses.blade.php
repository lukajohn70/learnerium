            ...
            <div class="p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 hover:bg-gray-50 transition">
                ...
                <div class="flex items-center gap-3 flex-shrink-0">
                    @if($course->isPreorder())
                        <span class="text-xs px-3 py-1 rounded-full font-bold bg-purple-100 text-purple-700 flex items-center gap-1">
                            <i class="fas fa-bookmark text-[10px]"></i> Pre-Order
                        </span>
                    @endif
