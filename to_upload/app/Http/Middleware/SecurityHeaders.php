...
class SecurityHeaders
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $response->headers->set(
            ...
            implode('; ', [
                "default-src 'self'",
                "script-src 'self' 'unsafe-inline' https://cdn.tailwindcss.com https://cdnjs.cloudflare.com https://js.paystack.co https://cdn.plyr.io https://www.youtube.com https://s.ytimg.com",
