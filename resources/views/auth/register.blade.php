...
<body class="antialiased text-gray-800 min-h-screen flex bg-gray-50">
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            ...
                            <input id="full-name" name="name" type="text" autocomplete="name" required
                                   class="input-field no-suffix" placeholder="e.g., John Abba Luka" value="{{ old('name') }}"
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            ...
                            <input id="email-address" name="email" type="email" autocomplete="email" required
                                   class="input-field no-suffix" placeholder="name@domain.com" value="{{ old('email') }}">
                        </div>
                        @error('email')
                            <p class="text-red-500 text-xs mt-1.5 flex items-center gap-1 font-medium"><i class="fas fa-exclamation-circle"></i>{{ $message }}</p>
                        @enderror
    ...
    <script>
        ...
        // Live Learnerium Handle Preview
        function updateVirtualBadge(name) {
            ...
            // Convert name to clean slug like firstname.lastname
            const clean = name.trim().toLowerCase().replace(/[^a-z0-9\s]/g, '').replace(/\s+/g, '.');
            if (clean) {
