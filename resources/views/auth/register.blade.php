    ...
    <div class="w-full lg:w-7/12 flex items-center justify-center px-4 sm:px-8 py-12">
        <div class="w-full max-w-lg">
            ...
            <div class="lg:hidden text-center mb-8">
                ...
                <picture class="h-11 w-11 flex-shrink-0">
                    <source srcset="{{ asset('logo-icon.webp') }}" type="image/webp">
                    <img src="{{ asset('logo-only.png') }}" alt="Learnerium Logo" class="h-11 w-11 object-contain drop-shadow-lg transition group-hover:scale-105" width="44" height="44">
                </picture>
