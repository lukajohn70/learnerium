...
/**
 * ============================================================
 * LEARNERIUM — Database Migration Runner
 * ============================================================
 * Accessible via https://learnerium.com.ng/updatedb.php
 * Automatically executes all pending migrations on production.
 */

// Determine Laravel root directory
$laravelRoot = __DIR__;
...
if (!file_exists($laravelRoot . '/vendor/autoload.php')) {
    die('Could not locate vendor/autoload.php. Checked: ' . $laravelRoot);
}
...
<?= htmlspecialchars(trim($output) ?: 'No pending migrations. Database is already up to date!') ?>
            </div>
        </div>
